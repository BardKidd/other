    ...
    <table class="w-100 common-datatable datatable stripe order-column">
      ...
      <tbody>
        ...
        >
          ...
          <VP tag="td" name="訂購數量" rules="max_value:9999|min_value:1">
          ...
          <VP tag="td" name="寄倉數量" rules="max_value:9999|min_value:0">
            <input
              class="w-100"
              type="number"
              placeholder="請輸入數量"
