<template>
  <div
    id="readonlywarehouseexchangejob"
              ...
              <div class="p-3">
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="field">
                      ...
                      <input
                        type="text"
                        placeholder="退換貨原因"
                        v-model.trim="exchangeData.ExchangeReasonCode"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div class="table-wrap">
                  ...
                  >
                    ...
                    <tbody>
                      <tr
                        v-for="row of exchangeData.WarehouseExchangeProducts"
                        :key="row.WarehousePickupExchangeId"
                      >
                        <td>{{ row.ItemNo }}</td>
                        <td class="tdShort">
                          {{ row.ItemName }}/{{ row.Variant }}
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="field">
                      ...
                      <input
                        ...
                        type="text"
                        placeholder="付款方式"
                        v-model.trim="exchangeData.PaymentTermsCode"
                      />
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-6">
                        ...
                        <div class="switchBox_content">
                          <label class="switchBox_content_box">
                            <input
                              ...
                              name="NotTaxId"
                              :value="true"
                              v-model="exchangeData.NoInvoiceTax"
                            />
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="field">
                      ...
                      <input
                        ...
                        type="text"
                        placeholder="統一編號"
                        v-model.trim="exchangeData.InvoiceTax"
                      />
                    </div>
                  </div>
